  ...
  <UiPage>
    ...
    <div class="grid gap-8">
      ...
      <PriceCard
        ...
        cycle="/j"
        :features="[
          { label: 'Intégrations de maquettes', icon: 'i-mingcute-file-code-line' },
          { label: 'Refontes / Réusinages', icon: 'i-mingcute-recycle-line' },
          { label: 'Optimisations performances', icon: 'i-mingcute-rocket-line' },
